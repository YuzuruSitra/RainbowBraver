...
public class ExcelImporterMaker : EditorWindow
{
    ...
    void ExportEntity()
    {
        string templateFilePath = (sepalateSheet) ? "Assets/Resources/ImportAssets/Terasurware/Editor/EntityTemplate2.txt" : "Assets/Resources/ImportAssets/Terasurware/Editor/EntityTemplate.txt";
        ...
        Directory.CreateDirectory("Assets/Resources/ImportAssets/Terasurware/Classes/");
        File.WriteAllText("Assets/Resources/ImportAssets/Terasurware/Classes/" + className + ".cs", entittyTemplate);
    }
	
    void ExportImporter()
    {
        string templateFilePath = (sepalateSheet) ? "Assets/Resources/ImportAssets/Terasurware/Editor/ExportTemplate2.txt" : "Assets/Resources/ImportAssets/Terasurware/Editor/ExportTemplate.txt";
        ...
        Directory.CreateDirectory("Assets/Resources/ImportAssets/Terasurware/Classes/Editor/");
        File.WriteAllText("Assets/Resources/ImportAssets/Terasurware/Classes/Editor/" + fileName + "_importer.cs", importerTemplate);
    }
